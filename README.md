...
Тест test_add_new_book_chek_not_allowed_borders проверяет, что в список не было добавлено пустой книги, книги из 41 символа и книги из 50 символов.

Тест test_add_new_book_check_books_allow_borders проверяет, что в список добаляются книги из 1, 2, 39 и 40 символов.
